...
import { decryptGlobalIDFactory } from "./apis/decryptGlobalID.js";
...
import { encryptGlobalIDFactory } from "./apis/encryptGlobalID.js";
...
import { getTenorStickerMappingFactory } from "./apis/getTenorStickerMapping.js";
...
export class API {
    ...
    public decryptGlobalID: ReturnType<typeof decryptGlobalIDFactory>;
    ...
    public encryptGlobalID: ReturnType<typeof encryptGlobalIDFactory>;
    ...
    public getTenorStickerMapping: ReturnType<typeof getTenorStickerMappingFactory>;
    ...
    constructor(ctx: ContextSession, zpwServiceMap: ZPWServiceMap, wsUrls: string[]) {
        ...
        this.decryptGlobalID = decryptGlobalIDFactory(ctx, this);
        ...
        this.encryptGlobalID = encryptGlobalIDFactory(ctx, this);
        ...
        this.getTenorStickerMapping = getTenorStickerMappingFactory(ctx, this);
